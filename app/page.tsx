...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col pt-5 pl-5 pr-5 relative z-10" style={{ marginBottom: '200px' }}>
      ...
      <div className="flex flex-1 flex-col items-center justify-center" style={{ marginTop: '200px' }}>
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3">
          {/* First Row */}
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            ...
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>Security & Compliance</span>
          </div>
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            <svg width="70" height="70" viewBox="0 0 24 24" fill="#040f2d"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>Innovation & Performance</span>
          </div>
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            ...
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>Global Reach</span>
          </div>
          {/* Second Row */}
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            ...
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>AI Powered</span>
          </div>
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            ...
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>Transparency</span>
          </div>
          <div className="p-4 flex flex-col items-center justify-center" style={{ backgroundColor: '#f4f2ee' }}>
            ...
            <span style={{ color: '#191919', marginTop: '10px', textAlign: 'center' }}>Cost Savings</span>
          </div>
      </div>
    </div>
    </>
